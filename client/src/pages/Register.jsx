...
const Register = () => {
  ...
  useEffect(() => {
    ...
    if (signinUserData.isError) {
      const errorMessage = signinUserData.error?.data?.msg || 
                          signinUserData.error?.message || 
  ...
  useEffect(() => {
    ...
    if (loginUserData.isError) {
      const errorMessage = loginUserData.error?.data?.msg || 
                          loginUserData.error?.message || 
